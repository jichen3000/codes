...
public:
  ...
  virtual const char* what() const throw() {
    cout << "  at " << _location << endl;
    cout << "    expected value: " << _expected << endl;
    cout << "      actual value: " << _actual;
    ostringstream os;
...
public:
  ...
  virtual const char* what() const throw() {
    cout << "  at " << _location << endl;
    cout << "    an exception was expected" << endl;
...
public:
  ...
  virtual const char* what() const throw() {
    cout << "  at " << _location << endl;
    cout << "    an unexpected exception ocurred" << endl;
    cout << "    expected type: " << _expected << endl;
    cout << "    but got: " << _actual;
    ostringstream os;
    os << "  at " << _location << endl;
