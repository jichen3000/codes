...
class HopfieldNetwork(EnergeticNetwork):
    def __init__(self, neuron_count):
        ...
        # colin: self.activation_function(" ") = 1
        # colin: self.activation_function("0") = 1
        # colin: self.activation_function("1") = 1
    ...
    def run(self):
        ...
        """
        # colin: len(current_state) is neuron_count, 100
...
class TrainHopfieldHebbian:
    # colin: This just calculate the sum_matrix which present the relationship 
    # of every elements in the original data
    # why relationship should be * aka multiple
    def __init__(self, network):
        self.network = network;
        # colin: self.sum_matrix.shape == [100, 100]
