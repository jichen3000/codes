...
def __perform_by_opening(the_image, kernel):
    return cv2.morphologyEx(the_image, 2, kernel)

def __perform_by_closing(the_image, kernel):
    return cv2.morphologyEx(the_image, 3, kernel)

def __perform_by_gradient(the_image, kernel):
    return cv2.morphologyEx(the_image, 4, kernel)

def __perform_by_top_hat(the_image, kernel):
    return cv2.morphologyEx(the_image, 5, kernel)

def __perform_by_black_hat(the_image, kernel):
    return cv2.morphologyEx(the_image, 6, kernel)
