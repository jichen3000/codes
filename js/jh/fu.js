...
var getMap = {};
fu.addGet = function (path, handler) {
  //console.log('fu.get, handler: %s', handler);
  getMap[path] = handler;
};
fu.addPost = function (path, handler) {
  getMap[path] = handler;
};

var server = createServer(function (req, res) {
  //console.log("request linstener, method: %s, url: %s", req.method, req.url);
...
fu.staticHandler = function (filename) {
  ...
  return function (req, res) {
    //console.log('staticHandler return function');
    loadResponseData(function () {
      //console.log('loadResponseData callback');
